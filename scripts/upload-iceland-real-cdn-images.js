...
async function uploadIcelandProductsWithRealImages() {
  try {
    console.log('🛒 Starting Iceland products upload with real CDN images...');
    
    // Load Iceland products with real CDN images
    ...
    console.log(`📦 Found ${products.length} Iceland products with real CDN images`);

    if (products.length === 0) {
      console.log('❌ No products found in the products array');
      return;
    }
    ...
    console.log(`✅ Successfully uploaded ${uploadedCount} Iceland products with real CDN images to ${storeId}`);
...
async function main() {
  try {
    console.log('🚀 Starting Iceland upload with real CDN images...');
    
    await uploadIcelandProductsWithRealImages();
